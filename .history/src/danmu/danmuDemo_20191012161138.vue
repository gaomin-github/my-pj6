    ...
    <section>
        <section class="player-container">
            <section class="animation">
                <section class="animation-item" ref="animationItem">this is animation test</section>
            </section>
        </section>
        ...
        displayAnimation() {
            ...
            this.$nextTick(() => {
                setTimeout(() => {
                    ...
                    animationDom.style.left = `${SW * 0.8}px`;
                    animationDom.style.transition = `transform ${Duration}ms linear 0s`;
                    // animationDom.style.transform = `translateX((-${SW * 0.8 +
                    // animationTestText.length * 16})px)`;
                    // animationDom.style.transform = `translateX(-${SW * 0.8 +
