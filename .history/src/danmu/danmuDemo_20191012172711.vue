    ...
    methods: {
        ...
        filterDanmu() {
            ...
            this.danmuDisplayTimer = setInterval(() => {
                ...
                // 当前屏显示信息
                let filterIndex=this.danmuQueue.findIndex(danmu=>
                    danmu.startTime>(new Date().getTime()-this.startMills+Duration)
                )
                let data=this.danmuQueue.
            });
        }
    }
};
