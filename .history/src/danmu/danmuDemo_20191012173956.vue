        ...
        filterDanmu() {
            ...
            this.danmuDisplayTimer = setInterval(() => {
                ...
                for (i in danmuQueue) {
                    ...
                    // 当前屏显示信息
                    if (danmuQueue.startTime < new Date().getTime()) continue;
                    if (danmuQueue.startTime > new Date().getTime() + Duration)
                        continue;
                    this.displayDanmu(this.danmuQueue[i]);
                }
