    ...
    methods: {
      ...
      startPlayer(lastTime) {
        ...
        this.startTimer = setInterval(() => {
          ...
          this.playMills = lastTime + currentMills - startMills;
          console.log("displaymills:" + displayMills);
      ...
      pausePlayer() {
        this.playMills = new Date().getTime() - this.startMills;
        clearInterval(this.startTimer);
      },
      continuePlayer() {
        this.startPlayer(this.playMills);
      },
      // 弹幕数据抓取
      initDanmuList() {
        for (let i = 0; i < 10; i++) {
