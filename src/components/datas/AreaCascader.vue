<template>
    <section class="container">
        <auto-complete class="prov" :dataSource="provinceList" :value="curProvinceName" @input="handleProvInput"
                       @complete-input="handleProvCompleteInput" :allowEdit="false"></auto-complete>
        <auto-complete class="city" :dataSource="cityList" :value="curCityName" @input="handleCityInput"
                       @complete-input="handleCityCompleteInput"></auto-complete>
    </section>
</template>
<script lang="ts">
    //地区联动控制
