    ...
    methods: {
        ...
        manualAddDanmu() {
            ...
            let danmu = {
                index: this.danmuNum++,
                // index: random,
                startTime: this.timeline + Math.floor(random * 1000),
                duration: Duration,
                fontSize:
                    random * 10 < 3
                        ? 12
        ...
        channelCheck(danmu, pool) {
            ...
            let channels = pool.channels.filter((channel) => {
                ...
                let channelRight = (channel.danmu.width + playerWidth) * (this.timeline - channel.danmu.createTime) / channel.danmu.duration;
